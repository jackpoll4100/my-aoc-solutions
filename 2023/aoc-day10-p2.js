...
for (let i = 0; i < coordArr.length; i++) {
    area += coordArr[i][0] * coordArr[(i + 1) % coordArr.length][1] - coordArr[i][1] * coordArr[(i + 1) % coordArr.length][0];
}

// The area:
console.log(area / 2);

// Apply Pick's Theorem in reverse:
console.log((area + 2 - coordArr.length) / 2);
